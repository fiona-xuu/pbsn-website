...
const Fifteen = () => {
    const teamMembers = [
        { id: 1, name: "Gordon Sun", position: "VP Projects", linkedin: "https://www.linkedin.com/in/gordon-sun/" },
        { id: 2, name: "Trisha Armena", position: "VP Media", linkedin: "https://www.linkedin.com/in/trisha-armena/" }
    ];
